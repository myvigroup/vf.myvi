...
export default async function DashboardPage({
  ...
  const { status: activeFilter, view } = await searchParams
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between gap-3 mb-3 flex-wrap">
        {/* Pipeline Filter (only in table view) */}
        {!isPipelineView ? (
              ...
              >
                ...
                <div className="space-y-2">
                  {colDeals.map((deal) => (
                    ...
                    >
                      <div className="text-sm font-semibold mb-1.5" style={{ color: 'var(--g800)' }}>
                        {deal.Title}
                      </div>
                      <div className="text-[0.7rem] mb-1" style={{ color: 'var(--g500)' }}>
                        {deal.Interesse_an || '—'}
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[0.68rem]" style={{ color: 'var(--g400)' }}>
                          {deal.Created ? new Date(deal.Created).toLocaleDateString('de-DE') : ''}
                        </span>
                      </div>
                    </Link>
                  ))}
                  {colDeals.length === 0 && (
                    <div
                      ...
                      style={{ color: 'var(--g300)', border: '1px dashed var(--g200)' }}
                    >
                      Keine Deals
                    </div>
                  )}
          ...
          {filteredDeals.length > 0 ? (
            ...
            >
              <div className="text-sm" style={{ color: 'var(--g400)' }}>
                {activeFilter
                  ? `Keine Deals mit Status "${activeFilter}".`
